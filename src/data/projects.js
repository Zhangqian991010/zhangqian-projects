...
export const projects = [
  {
    ...
    intro: [
      ...
      '与此同时，我独立运营小红书、贴吧官方社群，并参与抖音账号运营与达人联动营销：策划内容选题、撰写宣传互动帖、剪辑活动视频、跟进投流与数据复盘，把运营动作落到一张可执行的内容排期表里。'
    ],
    story: [
      {
        title: '接手小红书官方账号，从运营视角做内容',
        text: '入职后接手《梦幻西游》电脑版小红书官方账号：整理账号定位、内容方向与数据基线，从玩家视角转向运营视角，撰写宣传互动帖并维护评论区。官方账号说的每句话都代表产品，措辞、语气、信息准确度都有要求。',
        img: 'images/work/netease-xhs.png',
        caption: '《梦幻西游》电脑版小红书官方账号（1.5 万粉丝）'
      },
      {
        title: '维护公告宣发与玩家反馈收集',
        text: '参与时间服维护公告的宣发跟进：暑假活动第二阶段、月度英雄榜优化等内容同步发布。公告信息密度高、玩家关注点分散，我快速提炼关键信息组织评论区回应，并把玩家反馈分类归档到反馈台账。',
        img: 'images/work/netease-maintain.png',
        caption: '时间服维护公告 · 8 月 11 日版本节点'
      },
      {
      ...
      {
        title: '活动视频素材整理与短视频剪辑',
        text: '围绕畅玩服明星邀请赛等线下活动，收集整理视频素材（现场画面、嘉宾镜头、活动花絮），筛选可用片段并分类归档，用剪映完成竖屏短视频剪辑：调色、卡点、控制节奏，配合活动节点做宣传。',
        img: 'images/work/netease-edit.png',
        caption: '剪映专业版 · 竖屏短视频剪辑界面'
      },
      {
        title: '抖音账号运营与达人联动营销',
        text: '参与《梦幻西游》电脑版抖音官方账号日常运营，跟进旭旭宝宝 × 梦幻西游联动营销：视频剪辑、内容发布、数据观察。我第一次接触达人联动，理解了内容创意、流量放大与转化复盘的完整链路。',
        img: 'images/work/netease-douyin.png',
        caption: '《梦幻西游》电脑版抖音官方认证账号'
      },
      {
        title: '联动内容数据复盘',
        text: '旭旭宝宝空降畅玩服明星邀请赛的联动视频获得高互动：点赞 4400+、评论 1000+。我跟进这些数据，观察哪些内容更能引发讨论，把反馈带到下一轮选题，形成内容生产到复盘的闭环。',
        img: 'images/work/netease-douyin-video.png',
        caption: '旭旭宝宝 × 梦幻西游联动视频 · 高互动内容'
      },
      {
        title: '把工作做成可交付的成果',
    ...
    gallery: [
      { src: 'images/work/netease-xhs.png', caption: '小红书官方账号 · 1.5 万粉丝' },
      { src: 'images/work/netease-douyin.png', caption: '抖音官方认证账号' },
      { src: 'images/work/netease-maintain.png', caption: '时间服维护公告' },
      { src: 'images/work/netease-event.png', caption: '畅玩服明星邀请赛 · 现场素材' },
      { src: 'images/work/netease-edit.png', caption: '剪映专业版 · 短视频剪辑' },
      { src: 'images/work/netease-douyin-video.png', caption: '旭旭宝宝联动视频 · 高互动' },
    ...
    learning: [
      '从玩家到运营者，是我入职后的第一课：官方账号说的每句话都代表产品，措辞、语气、信息准确度都有要求。写文案之前先列信息点，再想表达方式，最后还要检查一遍有没有歧义——内容不是自嗨，而是服务。',
      '玩家反馈是零散的、情绪化的，甚至互相矛盾。我学会先分类再判断：把同一类问题归到一起，看它被多少人提起、情绪有多强烈，才能判断优先级。台账不是记录工具，而是决策依据，把零散的声音变成可行动的数据。',
      '短视频剪辑让我明白“节奏就是内容的一部分”：同样的素材，剪成 15 秒和 30 秒传递的信息完全不同。内容制作是从素材到表达的过程，筛选、取舍、重组，每一个决定都在影响观众看到的作品。',
      '第一次接触达人联动与抖音运营，我理解了内容 + 流量 + 数据的完整链路：好内容需要被更多人看到，投流是放大内容的杠杆，但前提是内容本身能接住流量。点赞、评论、收藏不是冷冰冰的数字，而是观众用行动给出的反馈。',
      '参与营销活动筹备，我完整走了一遍从内容创意、活动落地到数据复盘的运营链路，养成了记录追踪运营效果、复盘活动数据的工作习惯。'
    ]
  },
  {
    id: 'yuexiu',
    ...
    docs: [],
    learning: [
      '全程参与马场 CBD 建设、“领秀五期”领导力项目，我学会了把繁重的会务工作拆成清晰的任务清单：用台账管理进度，确保每个节点都能按时交付。大型项目统筹，靠的不是临时发挥，而是把每个环节都管住。',
      '熟练运用 Office + AI 工作流：用 Word + AI 快速生成会议纪要初稿并人工校准，用 Excel 梳理分工与进度、汇总生成图表。工具的价值不是替代人，而是把重复劳动压缩，把时间留给真正需要判断的事。',
      '在国企大型项目中，跨部门协同与严谨台账是最重要的能力：对接多个部门、推动会议落地、复盘进度，每一个环节都要求留痕、可追溯。这段经历让我养成了规范的项目管理习惯，也让我明白，靠谱比聪明更重要。'
    ]
  },
  {
    id: 'nanfang',
    ...
    en: 'NANFANG DAILY',
    summary:
      '在广东南方日报出版社担任内容运营：围绕图书卖点撰写新媒体短文案 18 篇，参与宣传物料筹备与素材归集，建立可复用的宣传素材台账，用 AI 辅助内容生产并人工复核，兼顾内容质量与产出效率。',
    accent: '#3a2a4d',
    accent2: '#1a1226',
    ...
    intro: [
      '在南方日报出版社，我以内容运营的身份参与图书新媒体内容策划与发布：围绕图书卖点撰写宣传短文案，参与配套宣传物料筹备与素材归集，建立可复用的宣传素材台账。',
    ...
    learning: [
      '做图书内容运营，最大的困难是“卖点”的提炼：一本厚厚的书，哪些内容值得写进宣传文案，哪些话读者会关心，都需要从读者视角重新判断，而不是把书的内容平铺直叙地搬上去。',
      '文案和校对是两种相反的思维：文案要抓眼球、找共鸣，校对要抠细节、讲准确。我学会先写文案、再校对，用 AI 辅助初稿和初查，人工负责最终判断，效率和准确率才同时提上来。',
      '18 篇文案、40+ 份校对记录、一套可复用的素材台账，让我把“内容”两个字理解得更完整：它既是面向读者的表达，也是经得起推敲的质量。'
    ]
  },
  {
    id: 'gree',
    ...
    en: 'GREE ELECTRIC',
    summary:
      '在珠海格力电器担任数据运营：按渠道汇总投递量、邀约、面试、录用各环节数据并建立标准化台账，对比渠道效果与成本，用数据支撑运营策略调整。',
    accent: '#4a5a6a',
    accent2: '#1f2937',
    hero: 'images/work/gree-3.jpg',
    tags: ['数据台账', '渠道分析', '数据复盘', '流程管理'],
    metrics: [
    ...
    learning: [
      '第一次接触海量业务数据时，最头疼的是“乱”：不同渠道的数据格式不一样，漏记一条，后面的统计就全不对。我意识到，数据运营的第一课不是分析，而是把台账做对。',
      '做渠道对比时，我学会用数据说话：把投递量、邀约率、面试通过率、Offer 接受率、单入职成本逐项算清楚，才发现内推转化率最高（26.6%）、官网成本最低——这些结论不是猜出来的，而是算出来的。',
      '在格力，我建立了严谨规范、标准化的数据管理意识：每一个字段、每一条记录都有意义。熟练用 AI 和办公软件整理数据后，我更能把时间花在分析和建议上，而不是重复劳动上。数据不会说谎，前提是你把台账做对了。'
    ]
  },
  {
    id: 'xhs',
    ...
    docs: [],
    learning: [
      '独立运营让我理解了“内容生产闭环”：定位、选题、制作、发布、复盘，每一步都要自己负责。账号能持续增长，靠的不是运气，而是稳定输出对用户真正有用的内容。',
      '把知识讲清楚是一种能力：能教会别人，才是真正理解。我坚持手写整理知识点，把抽象概念画成图、讲清楚答题思路，这些内容不仅帮到考生，也证明了我对知识的掌握程度。',
      '服务用户的核心是共情：考完试收到“感觉考砸了”的私信，我写下数千字长文分享自己的经历，不回避失误。用户需要的不仅是答案，还有被认真对待的感觉。'
    ]
  }
]
